...
public class TaskList {
    ...
    //one taskList to many tasks, taskList will be the instance variable
    //to set up the relationship between Task and TaskList class
    private List<Task> tasks; //this is a bidirectional relationship
